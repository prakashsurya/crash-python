...
class DecodeBufferHead(Decoder):
    ...
    def __init__(self, bh: gdb.Value):
        super(DecodeBufferHead, self).__init__()
        self.bh = bh
...
@overload
def register_decoder(endio: gdb.Symbol, decoder: Decoder) -> None: ...

@overload
def register_decoder(endio: gdb.Value, decoder: Decoder) -> None: ...

@overload
def register_decoder(endio: int, decoder: Decoder) -> None: ...

def register_decoder(endio, decoder):
    """
...
class GenericBioDecoder(Decoder):
    ...
    def __init__(self, bio):
        super(GenericBioDecoder, self).__init__()
        self.bio = bio
