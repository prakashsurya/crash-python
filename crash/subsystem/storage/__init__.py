...
from crash.subsystem.storage.decoders import decoders
...
def dev_to_part(dev):
    ...
    """
    return container_of(dev, hd_struct_type.get(), '__dev')
...
def for_each_block_device(subtype=None):
    """
