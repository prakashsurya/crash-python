...
class CrashKernel(object):
    ...
    def extract_modinfo_from_module(self, modpath):
        f = open(modpath, 'rb')
    ...
    def check_module_version(self, modpath, module):
    ...
    def setup_tasks(self):
        ...
        rqs = get_percpu_var(self.symbols.runqueues)
